    ...
    <>
      ...
      <div style={{ marginBottom: "4rem" }}>
        <Flex align="center" py="5" px="10" backgroundColor="teal.600">
          <Heading color={colorMode === "light" ? "#fff" : "#000"} size="md">
            Shop Headphones
          </Heading>
          <IconButton
            ml="4"
          ...
          />
          <Button colorScheme="teal" backgroundColor="teal.500" ml="4">
            View Cart
          </Button>
        </Flex>
        <Collapse in={isOpen} animateOpacity>
          ...
          >
            {["Recommended", "Latest", "Wired", "Wireless", "Gaming"].map(
              (text) => (
                <Text
                  fontWeight="bold"
        ...
        <Flex direction="column" w="container.lg" px="12" mt="12" mx="auto">
          ...
          <Slide direction="bottom" in={isOpen2} style={{ zIndex: 10 }}>
            <Box
              p="40px"
              color="white"
              mt="4"
